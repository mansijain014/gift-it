      ...
      <main>
        <div className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-screen-75">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1608755728617-aefab37d2edd?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80')",
            }}
          >
            <span
              id="blackOverlay"
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap">
              ...
              <div className="w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    <div className="text-white p-3 text-justify-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-lightBlue-400">
            ...
            <div className="flex flex-wrap items-center mt-32">
              ...
              <div className="w-full md:w-4/12 px-4 mr-auto ml-auto">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                  <img
                    alt="..."
                    src="https://images.unsplash.com/photo-1512911455673-5b69a621b1a0?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTV8fGRvbmF0ZSUyMGdpZnR8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"
            ...
            <div className="items-center flex flex-wrap">
              <div className="w-full md:w-4/12 ml-auto mr-auto px-4">
                <img
                  ...
                  src="https://images.unsplash.com/photo-1607920592519-bab4d7db727d?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mjd8fGdpZnRzfGVufDB8MXwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"
                />
              </div>
